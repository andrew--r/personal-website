        ...
        <div class="page-home__main content">
          <section>
            ...
            <p>
              ...
              <s>Avito</s> → <s>Sticker.place</s> → <s>Joom</s> →{' '}
              <span class="nobr">
                <svg
            ...
            <section>
              ...
              <ul>
                <li>
                  <a href="https://forweb.dev">For Web</a>, одно из крупнейших
                  русскоязычных <span class="nobr">фронтенд-сообществ</span> в
                  {' '}
                ...
                <li>
                  <a href="https://frontendcs.com">Frontend case studies</a>,
                  коллекция материалов о промышленном опыте разработки фронтенда
                ...
                <li>
                  ...
                  , цветовая схема Alabaster для highlight.js
                </li>
              </ul>
            </section>
            ...
            <p class="paragraph">
              ...
              <a href="https://github.com/frontendermagazine">
                Frontender Magazine
              </a>
              , <a href="https://habrahabr.ru/users/andrew-r">Хабрахабре</a>,{' '}
              <a href="https://forweb.dev">Форвебе</a> и{' '}
